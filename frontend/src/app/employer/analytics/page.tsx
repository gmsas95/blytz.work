      ...
      <div className="container mx-auto px-4 max-w-7xl py-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>View detailed analytics about your hiring activity</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <BarChart3 className="h-16 w-16 text-slate-400 mx-auto mb-4" />
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Analytics Coming Soon</h3>
              <p className="text-slate-600">Track metrics about your job postings, applications, and hires</p>
            </div>
          </CardContent>
        </Card>
      </div>
