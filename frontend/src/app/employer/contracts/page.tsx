  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="container mx-auto px-4 max-w-7xl py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Contracts</h1>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Track payments and deliverables for all contracts</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <FileText className="h-16 w-16 text-slate-400 mx-auto mb-4" />
              <h3 className="text-lg font-semibold text-slate-900 mb-2">No contracts yet</h3>
              <p className="text-slate-600">Contracts will appear here when you hire a VA</p>
            </div>
          </CardContent>
        </Card>
      </div>
